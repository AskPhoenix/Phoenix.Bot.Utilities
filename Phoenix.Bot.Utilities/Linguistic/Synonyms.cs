namespace Phoenix.Bot.Utilities.Linguistic
{
    public static class Synonyms
    {
        ...
        public static readonly string[] Exams = new string[] { "exam", "exams", "εξέταση", "εξετάσεις", "διαγώνισμα", "διαγωνίσματα" };
        public static readonly string[] Schedule = new string[] { "schedule", "πρόγραμμα" };
    }
}